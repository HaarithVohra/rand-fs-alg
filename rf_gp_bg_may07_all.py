...
max_n_itr_new = 60         # number of iterations per new algorithm run (except original one and warm start)
max_n_itr_warm_start = 60  # maximum number of iterations of warm start
max_n_itr_org = 100        # maximum number of iterations of org algorithm
